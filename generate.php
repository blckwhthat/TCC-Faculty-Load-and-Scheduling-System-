...
$pdf = new FPDF('P','mm','A4');
            ...
            $pdf->SetX(10);
            $pdf->SetFont('Arial','',10);
            $pdf->Cell(200,4,"Other assignment and equivalent unit-load:",0,1,'L');
            //TOTAL NUMBER OF UNITS
            $pdf->SetX(10);
            $pdf->Ln(4);
            $pdf->Cell(70,4,"NONE",0,1,'C');
            $pdf->Ln(4);
