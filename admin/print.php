...
<
   ...
   <h5 align="center" class="title-rep" style="margin-top: 80px;">Faculty Load Report</h5><br>
			...
			<div class="col-md-12">
				<div class="card mb-3 noprint">
					...
					<div class="card-body shadow">
   						<form action="../generate.php" method="GET" class="noprint" target="_blank">
						   
   							<div class="row">  
   								<div class="col-md-4 form-group">
								   		<label for="" class="control-label">Choose Faculty</label>	
