		...
		<div id="login-top" class="red"></div>
  		...
  		<div id="login-right" class="new-color">
  			<div class="card col-md-8 new-color">
                  ...
                  <form id="login-form" >
                  <center><label for="" class="control-label text-dark text-login">Welcome Faculty</label></center>
  						<div class="form-group">
  							<label for="id_no" class="control-label text-dark">Please enter your Faculty ID No.</label>
  							<input type="text" id="id_no" name="id_no" class="form-control">
  						</div>
								
						<center><button class=" btn  btn-wave btn-primary  btn-block col-md-12">Login</button></center>

						<center><a href="../load/admin/login.php" class="btn btn-wave btn-block  btn-danger col-md-12 mt-2">Cancel</a></center>
